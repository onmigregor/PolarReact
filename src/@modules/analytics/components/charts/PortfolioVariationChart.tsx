// ** Portfolio Variation Chart — Recharts Donut + Table
...
const PortfolioVariationChart = ({ data, totals, loading }: Props) => {
            ...
            <Box sx={{ height: 280, mb: 2 }}>
              <ResponsiveContainer>
                <PieChart>
                  <Pie
                    data={data}
                    dataKey='sap' // Usar clientes SAP como peso principal del gráfico de torta
                    nameKey='territory'
                    cx='50%'
                    cy='50%'
                    innerRadius={70}
